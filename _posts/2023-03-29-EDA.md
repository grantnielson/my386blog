---
layout: post
title:  "Hardwood Analytics - What makes a Successful NCAA Tournament Team?"
author: Grant Nielson
description: A follow-up post to visually explain the qualities of good NCAA basketball teams
...
I previously scraped and cleaned data from sports-Reference.com from the 2021 College Basketball season, with the intent of learning what the characteristics are of teams who qualify or are selected to participate in the 68-team "March Madness" tournament at the end of the year. Additionally, I want to know which stats are good at explaining the teams who win lots of games once they get to the tournament.

This blog is split up into sections based on the stats we are analyzing.
...
<iframe
  src="{{site.url}}/{{site.baseurl}}/assets/images/fgp%.html"
  style="width:100%; height:500px;"
></iframe>
